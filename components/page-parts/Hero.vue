<template>
  <section class="relative bg-white overflow-hidden">
    <div class="max-w-7xl mx-auto">
      <div
        class="relative z-10 py-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32"
      >
        <svg
          ...
          <div class="sm:text-center lg:text-left">
            ...
            >
              <div class="rounded-md shadow">
                <nuxt-link
                  to="/recipes"
                  class="'w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#f1ac18] hover:bg-[#f25b0a] md:py-4 md:text-lg md:px-10 transition ease-in duration-150"
                  >See Recipes</nuxt-link
                >
              </div>
